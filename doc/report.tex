...
alvioli in the lungs. \todo{figures (from talk?)}
\todo{More examples? Other fields - geology, \ldots}
...
\todo{existing work - Chernyavsky et al.}

\chapter{Individual based approach}
\todo{introduction to individual based approach}
\todo{move problem description (urns) here}
...
\todo{remove \(Y_i(t)\) and just use \(\E{n_i}\)}
